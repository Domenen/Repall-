...
# for item in events:
#     if events[i]["eventType"].startswith("itemViewEvent"):
#         itemViewEvent1 = itemViewEvent1 + 1
#     else:
#          itemBuyEvent1 = itemBuyEvent1 + 1
#     i = i + 1

# print(itemViewEvent1)
# print(itemBuyEvent1)
...
# for item in events:
#     if events[i]["detectedDuplicate"] == True:
#         print("дубли есть")
#     else:
#         print("Дублей нет")
#     i = i + 1
...
# buy = 0
# while i != len(events):
#     if events[i]["eventType"] == "itemBuyEvent":
#         buy = buy + events[i]["item_price"]
#     i = i + 1
...
while i != len(events):
    if events[i]["firstInSession"] == True:
        sobyt = events[i]["pageViewId"]
    i = i + 1
