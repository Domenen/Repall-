...
# --------------------------------------------------------
book = {"itemViewEvent": 0 , 
         "itemBuyEvent": 0}

for event in events:
    if event["eventType"] == "itemViewEvent":
        book["itemViewEvent"] = book["itemViewEvent"] + 1
    else:
        book["itemBuyEvent"] = book["itemBuyEvent"] + 1
print(book)
...
# ----------------------------------------------------------
for event in events:
    if event["detectedDuplicate"] == True:
        Duplicate = True
    else:
        Duplicate = False
print("Дубли",Duplicate)
...
for event in events:
    if event["eventType"] == "itemBuyEvent":
        priceMax = priceMax + event["item_price"]
print(priceMax)


# ----------------------------------------------------------
for event in events:
    if event["firstInSession"] == True:
